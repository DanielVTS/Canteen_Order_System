...
public class ClientOrderView1 extends JPanel implements ActionListener {
	...
	public ClientOrderView1(JFrame jFrame,int _tableID) {
	...
	private void initView() {
		...
		Vector<Order> vm = sd.find(tableID);// 101为选择的参数
